...
#define HELP_NAME "hR"
/*#define ISCTRL(c)    (((c)&0140) == 0 || (c)==0177) /*bvg*/
#define ISCTRL(c)    (((c)&0340) == 0 || (c)==0177)
...
EXTERN char *ch_scroll; /* Как установить область роллинга */
EXTERN short n0scroll, n1scroll; /* Текущая область роллинга - ttext, btext */
EXTERN short can_scroll;         /* Вариант реализации роллинга */
#define ROLL_CS 01
#define ROLL_IL 02
#define ROLL_SF 03

...
// UTF8 #define RED_CYRILL              /* Работать с русскими самому  */
...
#define RUSDIAG                                         /* bvg*/
#define LATFLG(ttyio)   0                               /* bvg UTF8*/
#define KIOFLG(ttyio)   0                               /* bvg*/
#define LCASEF(ttyio)   0  // ((ttyio.c_oflag & OLCUC) != 0)  /* bvg*/
//#define RED_ALT         /*  bvg */ /* CY if not install koi8-koi8  */
			/* else               alt-koi8  */
#define UTF8
